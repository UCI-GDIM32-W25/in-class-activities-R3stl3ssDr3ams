...
### Activity 2
A1: The value of x after running the program will be 10.
A2: The value of x after running the program will be 2
A3: An update functions runs every frame, meaning that every frame the phrase "hello world" will be displayed on the console.
A4: Monobehaviour
A5: The debug log on the console will pring "x = 10".
A6: The lines of code display an argument, which can be used within a parameter to allow for variance within the output depending on the input variable.
A7: Transform can not be called by itself, as the resulting translation will not be in accordance to any object ingame. 
A8:The variable "_playerTransform" would have to be called in order to create an instance of transformation.
